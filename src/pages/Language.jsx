...
const Language = (props) => {
    ...
    useEffect(() => {
        ...
        async function getFunctions(language) {
            const url =
              "https://raw.githubusercontent.com/code-whits/code-whits-" + language + "/main/misc/functions.json";
            await axios
              .get(url)
    ...
    return (
        <div>
            <NavbarComponent />
            < ListComponent items={functions} language={props.match.params.language} />
        </div>
    )
}
